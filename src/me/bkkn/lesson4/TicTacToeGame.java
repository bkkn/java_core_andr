package me.bkkn.lesson4;

import java.util.Random;
import java.util.Scanner;

/*
 Сначала написал свои методы для проверки, но когда увидел универсальный checkLine с урока - взял его.
 */
...
//    private static boolean check_row(int rowIdx, int x0, char dot) {
//        for (int i = x0; i < winLength; i++)
//            if (field[i][rowIdx] != dot)
//                return false;
//        return true;
//    }
//
//    private static boolean check_col(int colIdx, int y0, char dot) {
//        for (int i = y0; i < winLength; i++)
//            if (field[colIdx][i] != dot)
//                return false;
//        return true;
//    }
//
//    private static boolean check_main_diag(int i0, char dot) {
//        for (int i = i0; i < winLength; i++)
//            if (field[][i] != dot)
//                return false;
//        return true;
//    }
//
//    private static boolean check_main_diag(char dot) {
...
//    }
//
//    private static boolean check_side_diag(char dot) {
//        for (int i = 0; i < winLength; i++)
//            if (field[i][winLength - i - 1] != dot)
//                return false;
//        return true;
//    }
